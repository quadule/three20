...
#import "Three20UI/TTTableStyledMessageItem.h"
...
#import "Three20UI/TTTableStyledMessageItemCell.h"
...
- (Class)tableView:(UITableView*)tableView cellClassForObject:(id)object {
  if ([object isKindOfClass:[TTTableItem class]]) {
    ...
    } else if ([object isKindOfClass:[TTTableStyledMessageItem class]]) {
      return [TTTableStyledMessageItemCell class];
